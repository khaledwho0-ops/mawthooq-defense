# Motazen coverage: domain × status

| domain | status | count | ids |
|---|---|---|---|
| أزمة | established | 1 | self-harm-help |
| أزمة | contested | 0 |  |
| أزمة | debunked | 0 |  |
| أزمة | unknown | 0 |  |
| أسس | established | 21 | bz1-continuum-not-binary bz1-who-positive-definition bz2-false-division-clinical bz2-identity-theory bz2-positions-map bz2-subjective-character bz3-no-health-without bz3-top-ten-burden bz3-treatment-gap bz4-anecdote-not-evidence bz4-confirmation-bias-search bz4-illusory-truth bz5-replication-crisis bz5-stigma-paradox bz5-study-vs-know bz5-weird bz6-conditions-broader-than-disorders bz6-dismissing-real-illness-harms bz7-categories-are-human-decisions bz7-diagnostic-reach-is-expanding bz7-validation-rests-on-value-judgments |
...
| تنقّل | established | 3 | nav-help-underused nav-literacy-matters nav-stigma-barrier |
| تنقّل | contested | 0 |  |
| تنقّل | debunked | 0 |  |
| تنقّل | unknown | 1 | nav-frameworks-unknown |
| خريطة | established | 4 | p0-attend-positive p0-bps-frame p0-languishing p0-two-continua |
...
| سلوك | debunked | 0 |  |
| سلوك | unknown | 0 |  |
| صدمة | established | 6 | trauma-aces-childhood trauma-cbt-best-evidence trauma-features-clusters trauma-most-recover trauma-real-serious trauma-war-children |
...
| ضغط | debunked | 0 |  |
| ضغط | unknown | 0 |  |
| ضغط ونوم | established | 8 | sleep-behavioral-selfhelp sleep-cbti-first-line sleep-disruptors-caffeine-shift sleep-insomnia-features sleep-mental-health-bidirectional sleep-normal-vs-disorder stress-cardiometabolic-harm stress-response-adaptive-and-chronic |
| ضغط ونوم | contested | 2 | sleep-eight-hours-contested sleep-melatonin-overuse |
| ضغط ونوم | debunked | 1 | sleep-supplement-cortisol-misinfo |
| ضغط ونوم | unknown | 1 | sleep-why-we-sleep-unknown |
| قلق | established | 10 | anx-benzo-caution anx-common-yet-untreated anx-comorbidity-depression anx-cultural-somatic anx-disorder-line anx-exposure-avoidance anx-fear-adaptive anx-help-exists anx-subtypes ocd-basics |
...
| مهارات | established | 4 | skill-behavioural-activation skill-breathing skill-facing-avoidance skill-gratitude |
| مهارات | contested | 0 |  |
| مهارات | debunked | 0 |  |
| مهارات | unknown | 1 | skill-what-we-dont-know |
