> **BILINGUAL — ثنائي اللغة.** English defense script first, then the full Egyptian-Arabic delivery version. Opens with the vaccine cold open (COVID-19 / real-post case); موثوق-forward; real data.
...
# 🇪🇬 النسخة العربية المصرية (للإلقاء)
